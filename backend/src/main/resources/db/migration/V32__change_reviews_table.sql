...
INSERT INTO reviews (staff_num, books_num, stars, comment, reviews_date) 
VALUES (11, 9, 5, 'Impressive. Very nice. Let''s see Paul Allen''s portrait.', '2023-11-10');
...
GROUP BY id, title, author, average_rating, provider, status, cover_name, description;
